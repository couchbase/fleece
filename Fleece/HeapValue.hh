...
namespace fleece { namespace internal {
    ...
    static inline Value* retain(Value *v) {retain((const Value*)v); return v;}
    static inline void release(Value *v) {release((const Value*)v);}


    template <class T>
    RetainedConst<Value> NewValue(T t) {
        return HeapValue::create(t);
    }
